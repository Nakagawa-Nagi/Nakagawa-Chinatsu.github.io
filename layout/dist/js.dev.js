...
document.writeln("  <script src=\'https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.min.js\'></script>");
document.writeln("  <script src=\'https://cdn.jsdelivr.net/npm/glightbox@3.3.0/dist/js/glightbox.min.js\'></script>");
document.writeln("  <script src=\'https://cdn.jsdelivr.net/npm/isotope-layout@3.0.6/dist/isotope.pkgd.min.js\'></script>");
document.writeln("  <script src=\'https://cdn.jsdelivr.net/npm/validate.js@0.13.1/validate.min.js\'></script>");
document.writeln("  <script src=\'https://cdn.jsdelivr.net/npm/@srexi/purecounterjs@1.5.0/js/purecounter.js\'></script>");
document.writeln("  <script src=\'https://cdn.jsdelivr.net/npm/swiper@11.1.15/swiper-bundle.min.js\'></script>"); // document.writeln("  <script src=\'../../../../../../live2d_models/lib/L2Dwidget.min.js?094cbace49a39548bed64abff5988b05\'></script>");
...
document.writeln("<script src=\'https://cdn.jsdelivr.net/npm/hls.js@1.5.17/dist/hls.min.js\'></script>");